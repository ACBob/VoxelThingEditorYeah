...
BlockList::BlockList( EditorState *editorState, QWidget *parent ) : QDialog( parent )
{
...
uint16_t BlockList::getSelectedBlock() { return m_selectedBlock; }
...
void BlockList::onItemSelectionChanged() { onItemClicked( m_list->currentItem() ); }